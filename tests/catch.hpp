 ...
 *  ----------------------------------------------------------
 *  This file has been merged from multiple include. Please don't edit it directly
...
// In the impl file, we want to have access to all parts of the include
...
// NB. Any general catch include included here must be included
